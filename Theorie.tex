...
%-----------------------------------------------------
    ...
    Allgemein sind Gele Systeme aus mindestens zwei Komponenten, wobei eines ein festes dreidimensionales Netzwerk bildet und von einer Flüssigkeit oder einem Gas ausgefüllt ist. \todo{ref Pure Appl. Chem. 79 10 1801-1829,2007}
    
    Der klassische Bildungsmechanismus folgt meist dem Sol-Gel-Verfahren. \todo{ref mod.Gele}
    Dabei wird aus einem flüssigen System über stufenweise Umwandlungen von Vorstufen ein Sol gebildet woraus anschließend ein Gel entsteht. \todo{ref mod.Gele Q2}
    ...
    Dieses Problem konnte erstmals in der Arbeit von Brock und Monahan 2004 umgangen werden, durch kontrollierte Destabilisierung der Nanopartikel. \todo{ref 28,29}
    ...
    \end{figure}
    \todo{Caption+Ref Moderne Anorganische Chemie}
    
    Auf diese Weise können auch metallische Nanopartikel zu Gelen weiterverarbeitet werden. \todo{anders ausdrücken, ref Bigall}
    Diese zeigen vielversprechende Eigenschaften bei verschiedenen elektrokatalytischen Prozessen wie Alkoholoxidation, Sauerstoffreduktionsreaktion und Sauerstoffentwicklungsreaktion. \todo{ref14,21,22,30,37,38 Ran Du}
    Edelmetall-Nanostrukturen weisen einzigartige optische Eigenschaften auf, die eine Kopplung zwischen den kollektiven Oberflächenelektronenoszillationen und dem einfallenden elektromagnetischen Feld ermöglichen und so ein dramatisch verstärktes lokales elektrisches Feld für eine oberflächenverstärkte Raman-Streuung ergeben. \todo{ref{Ran Du 39,8 Review105}}
